...
##
proc window*(w: cint; h: cint; title: cstring; flags: cint): ptr Tigr {.cdecl, importc: "tigrWindow", header: vim.}

##  Creates an empty off-screen bitmap.
proc bitmap*(w: cint; h: cint): ptr Tigr {.cdecl, importc: "tigrBitmap", header: vim.}
...
proc beginOpenGL*(bmp: ptr Tigr): cint {.cdecl, importc: "tigrBeginOpenGL", header: vim.}

##  Sets post shader for a window.
##  This replaces the built-in post-FX shader.
proc setPostShader*(bmp: ptr Tigr; code: cstring; size: cint) {.cdecl, importc: "tigrSetPostShader", header: vim.}
...
proc setPostFX*(bmp: ptr Tigr; p1: cfloat; p2: cfloat; p3: cfloat; p4: cfloat) {.cdecl, importc: "tigrSetPostFX", header: vim.}

##  Drawing ----------------------------------------------------------------
##  Helper for reading pixels.
##  For high performance, just access bmp->pix directly.
proc get*(bmp: ptr Tigr; x: cint; y: cint): TPixel {.cdecl, importc: "tigrGet", header: vim.}

##  Plots a pixel.
##  Clips and blends.
##  For high performance, just access bmp->pix directly.
proc plot*(bmp: ptr Tigr; x: cint; y: cint; pix: TPixel) {.cdecl, importc: "tigrPlot", header: vim.}
...
##  Clips and blends.
proc circle*(bmp: ptr Tigr; x: cint; y: cint; r: cint; color: TPixel) {.cdecl, importc: "tigrCircle", header: vim.}
...
proc clip*(bmp: ptr Tigr; cx: cint; cy: cint; cw: cint; ch: cint) {.cdecl, importc: "tigrClip", header: vim.}
...
proc blit*(dest: ptr Tigr; src: ptr Tigr; dx: cint; dy: cint; sx: cint; sy: cint; w: cint; h: cint) {.cdecl, importc: "tigrBlit", header: vim.}
...
##  Clips and blends.
proc blitAlpha*(dest: ptr Tigr; src: ptr Tigr; dx: cint; dy: cint; sx: cint; sy: cint; w: cint; h: cint; alpha: cfloat) {.cdecl, importc: "tigrBlitAlpha", header: vim.}
...
##  Clips and blends.
proc blitTint*(dest: ptr Tigr; src: ptr Tigr; dx: cint; dy: cint; sx: cint; sy: cint; w: cint; h: cint; tint: TPixel) {.cdecl, importc: "tigrBlitTint", header: vim.}
type
...
proc blitMode*(dest: ptr Tigr; mode: cint) {.cdecl, importc: "tigrBlitMode", header: vim.}
...
proc print*(dest: ptr Tigr; font: ptr TigrFont; x: cint; y: cint; color: TPixel; text: cstring) {.varargs, cdecl, importc: "tigrPrint", header: vim.}
...
proc touch*(bmp: ptr Tigr; points: ptr TigrTouchPoint; maxPoints: cint): cint {.cdecl, importc: "tigrTouch", header: vim.}
...
proc readChar*(bmp: ptr Tigr): cint {.cdecl, importc: "tigrReadChar", header: vim.}
...
proc readFile*(fileName: cstring; length: pointer): pointer {.cdecl, importc: "tigrReadFile", header: vim.}
